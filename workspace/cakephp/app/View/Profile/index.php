<section class="flex items-center flex-col justify-center min-h-screen pt-36 pb-8">
    ...
    <form class="w-1/4 mx-auto" method="post"
        action="<?= $this->Html->url(array('action' => 'updateProfile')); ?>" enctype="multipart/form-data">
        ...
        <div class="mb-5 mt-5">
            ...
            <input value="<?= isset($user['name']) ? h($user['name']) : $currentUser['name']; ?>" type="text"
                id="name" name="name"
        ...
        <div class="relative max-w-sm mb-5">
            ...
            <input id="birthdate" name="birthdate" datepicker datepicker-format="yyyy/mm/dd" datepicker-autohide
                type="text"
                value="<?= isset($user['birthdate']) ? h($user['birthdate']) : $currentUser['birthdate']; ?>>"
