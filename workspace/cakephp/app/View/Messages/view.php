<section class="flex h-screen flex-col justify-center items-center w-full">
    ...
    <div class="flex items-center gap-1 m-1">
        <a href="/cakephp/profile/view/<?= $recipientID ?> ">
            <img class="w-10 h-10 rounded-full" src="<?= $this->Html->url("/" . $recipientImage); ?>" alt="Sender's Image">
        </a>
    ...
    <div id="messageContainer"
        ...
        <? if ($messageDetail["messages"]["receiver_id"] == $currentUserID): ?>
        ...
        <? elseif ($messageDetail["messages"]["sender_id"] == $currentUserID): ?>
        <div class="message flex justify-end items-center gap-2.5 mb-5">
            <div
                ...
                <p class="text-sm font-normal py-2.5 text-white dark:text-white"><?= $messageDetail[
               "messages"]["message"]; ?></p>
            </div>
            <div class="flex flex-col gap-2">
               ...
               <!-- 3dots -->
                <button id="dropdownMenuIconButton<?= $messageDetail['messages']['id']; ?>"
                    data-dropdown-toggle="msgOption<?= $messageDetail['messages']['id']; ?>"
            ...
            <div id="msgOption<?= $messageDetail['messages']['id']; ?>"
        ...
        <div id="deleteModal<?= $messageDetail['messages']['id'] ?> " tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    <button type="button"
                        ...
                        data-modal-toggle="deleteModal<?= $messageDetail['messages']['id'] ?> ">
...
$(document).ready(function() {
    ...
    // var params = <?= $this->request->params['pass'][0]; ?>;
    // setInterval(() => {
