<section class="flex h-screen flex-col justify-center items-center w-full">
    ...
    <div class="w-full m-5">
        <form class="max-w-md mx-auto" id="findMessageForm">
    ...
    <div id="messageContainer" class="relative w-full max-w-lg overflow-y-scroll bg-white border border-gray-100 rounded-lg dark:bg-gray-800 dark:border-gray-600 h-96 p-5">
