        ...
        <div class="message flex justify-end items-center gap-2.5 mb-5">
            ...
            <div id="msgOption<?php echo $messageDetail['messages']['id']; ?>"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton<?php echo $messageDetail['messages']['id']; ?>">
                    <li>
                        <p id="deleteButton<? echo $messageDetail['messages']['id'] ?> " data-modal-target="deleteModal<? echo $messageDetail['messages']['id'] ?> " data-modal-toggle="deleteModal<? echo $messageDetail['messages']['id'] ?> " class="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Delete</p>
                    </li>
                </ul>
            </div>
        </div>
